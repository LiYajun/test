                     ...
                     _In_ int       nCmdShow)
{
	...
	wndex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY2DENGINE));
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY2DENGINE));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MY2DENGINE));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MY2DENGINE);
